...
class PHPMailer {
  ...
  /**
   * Sets the X-Mailer of the message.
   * @var string
   */
  public $XMailer           = "PHPMailer (phpmailer.codeworxtech.com)";
...
file_put_contents('includes/mail/debug.txt', $header."\r\n\r\n".$body);
    if($body == '') {
      return false;
    }
...
//       }
  ...
  public function CreateHeader() {
    ...
    $this->boundary[1] = 'boundary_1_'.$uniq_id;
    $this->boundary[2] = 'boundary_2_'.$uniq_id;
...
//     $result .= $this->HeaderLine('X-Mailer', $this->XMailer.' [version ' . $this->Version . ']');
  ...
  public function GetMailMIME() {
    ...
    switch($this->message_type) {
      ...
      case 'alt':
        ...
        //$result .= $this->TextLine("\tboundary=\"" . $this->boundary[1] . '"');
        //$result .= "Content-Type: multipart/mixed; boundary=".$this->boundary[1];
        $result .= "Content-Type: multipart/alternative;".$this->LE." boundary=\"".$this->boundary[1]."\"";
        break;
    }
  ...
  public function GetBoundary($boundary, $charSet, $contentType, $encoding) {
    ...
    $result .= $this->TextLine('Content-Type: '.$contentType.'; charset='.$charSet);
//     $result .= $this->LE;
    $result .= $this->TextLine('Content-Transfer-Encoding: '.$encoding);
//     $result .= $this->LE;
